            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php foreach($modMenu['modulos'] as $hijos){ ?>
                    ...
                    <?php }else{ ?>
                        ...
                        <?php } else{?>
                            <?php if($hijos['idModulo'] == 43 && $_SESSION["project"]["info"]["idPerfil"] != 8){?>
                                <a class="collapse-item" style="display:none;" href="<?php echo base_url()?><?php echo $hijos['urlModulo'] ?><?php echo $hijos['idModulo'] ?>" title="<?php echo ucwords($hijos['nombreModulo']) ?>"><i class="<?php if($hijos['icono'] != ""){ echo $hijos['icono']; }else{ echo '';}?>" ></i> <?php echo ucwords($hijos['nombreModulo']) ?></a>
                            <?php }else{?>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <?php } else{ ?>
                        <img class="img-profile rounded-circle" src="<?php echo base_url()?>res/img/user.jpg">
                    <?php }?>
                </a>
