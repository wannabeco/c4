                            ...
                            <?php foreach($infoMatrices as $info){ ?>
                                <tr>
                                    ...
                                    <td style="width: 160px;">
                                        ...
                                        <button type="button" class="btn btn-primary float-left ml-2 duplicar" data-toggle="tooltip" data-placement="top" title="Adquirri" data-nombreNuevaMatriz="<?php echo $info["nombreNuevaMatriz"];?>" data-idNuevaMatriz="<?php echo $info["idNuevaMatriz"];?>">Adquirir</button>
                                        <!-- <button class="btn btn-primary float-right" type="button" ng-click="duplicar(<?php echo $info["idNuevaMatriz"];?>,<?php echo $info["nombreNuevaMatriz"];?>)"><i class="fas fa-folder-open"></i> Duplicar</button> -->
